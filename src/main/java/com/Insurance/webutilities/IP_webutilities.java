package com.Insurance.webutilities;
...
import com.Insurance.config.Configures;

public class IP_webutilities extends Configures
{
	public static Logger log=LogManager.getLogger(IP_webutilities.class);
